        ...
        <div class="row">
          <div class="form-group col-md-3">
            ...
            <select  class="form-control"  name="stream_from" required>
              ...
              <!-- <option value="embed" <?php if($live_tv['stream_from'] =='youtube_live'){ echo 'selected';} ?>>Youtube Live</option>
        ...
        <div class="row">
          <div class="form-group col-md-3">
            ...
            <select  class="form-control"  name="stream_from1">
              ...
              <!-- <option value="embed" <?php if($this->live_tv_model->get_stream_from($live_tv['live_tv_id'],'opt1') =='youtube_live'){ echo 'selected';} ?>>Youtube Live</option>
        ...
        <div class="row">
          <div class="form-group col-md-3">
            ...
            <select  class="form-control"  name="stream_from2">
              ...
              <!-- <option value="embed" <?php if($this->live_tv_model->get_stream_from($live_tv['live_tv_id'],'opt2') =='youtube_live'){ echo 'selected';} ?>>Youtube Live</option>
